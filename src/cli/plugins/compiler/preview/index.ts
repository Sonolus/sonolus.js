import {
    ...
    MainTaskArtifacts,
    assemble,
} from '@sonolus/sonolus.js-compiler/preview'
...
export const previewCompilerPlugin = (config: PreviewSonolusCLIConfig): Plugin => {
...
const compile = (config: PreviewSonolusCLIConfig, workerPool: WorkerPool) =>
